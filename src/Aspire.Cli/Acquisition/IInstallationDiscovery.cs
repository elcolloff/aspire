...
///     walks. Used by <c>aspire info</c> with no flags.</description>
///   </item>
///   <item>
///     <description><see cref="DiscoverAllAsync"/> — walks <c>$PATH</c> plus
///     well-known install prefixes and asks each peer to self-describe via
///     a child <c>aspire info --format json</c> call (subject to a trust
///     gate). Used by <c>aspire info --all</c>.</description>
///   </item>
/// </list>
/// </remarks>
internal interface IInstallationDiscovery
{
    ...
    /// trust gate refused to spawn them or the probe failed.
    /// </summary>
