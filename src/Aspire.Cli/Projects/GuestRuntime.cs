...
internal sealed class GuestRuntime
{
    ...
    {
        return await RunAsync(appHostFile, directory, environmentVariables, watchMode, launcher, runArgs: null, cancellationToken, afterAppHostLaunchedAsync: afterAppHostLaunchedAsync);
    }
