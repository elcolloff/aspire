...
internal sealed class GuestAppHostProject : IAppHostProject, IGuestAppHostSdkGenerator
{
        ...
        try
        {
            ...
            using (var guestStartupActivity = _profilingTelemetry.StartRunAppHostStartGuestAppHost(_resolvedLanguage.LanguageId))
            {
                ...
                (guestExitCode, guestOutput) = await ExecuteGuestAppHostAsync(
                    appHostFile, directory, environmentVariables, enableHotReload, rpcClient, launcher, context.UnmatchedTokens, StartBackchannelConnectionAfterGuestAppHostLaunchesAsync, cancellationToken);
            }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await _guestRuntime.RunAsync(appHostFile, directory, environmentVariables, watchMode, launcher, runArgs, cancellationToken, afterAppHostLaunchedAsync);
    }
